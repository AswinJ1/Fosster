        ...
        <section className="relative w-full min-h-screen bg-white text-black py-16 px-6 sm:px-10 lg:px-20 overflow-hidden">
            <div className="relative z-10 max-w-7xl mx-auto space-y-12">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mt-16">
                    ...
                    <p className="text-lg text-blue-600 text-center max-w-3xl mx-auto leading-relaxed">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mt-16">
                    ...
                    <p className="text-lg text-blue-600 text-center max-w-3xl mx-auto mb-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-10">
                        {[
                            { icon: PenTool, color: "bg-blue-100", title: "Receive Challenge", subtitle: "Get your pattern task" },
                            { icon: FileEdit, color: "bg-blue-100", title: "Write Regex", subtitle: "Create a precise pattern" },
                            { icon: CheckCircle, color: "bg-blue-100", title: "Test & Refine", subtitle: "Ensure perfect matching" },
                            { icon: Code, color: "bg-blue-100", title: "Submit Solution", subtitle: "Accuracy matters" },
                            ...
                            <div key={i} className="flex flex-col items-center text-center">
                                ...
                                <span className="font-semibold text-blue-600 text-sm">{i + 1}. {step.title}</span>
                                <span className="text-xs text-blue-600 mt-1">{step.subtitle}</span>
                            </div>
                        ))}
                    </div>

                    {/* Objective */}
                    <div className="bg-gradient-to-r from-blue-50 to-blue-50 border-l-4 border-blue-600 rounded-lg p-6 mb-8 shadow-sm">
                        <div className="flex items-center mb-2">
                            <div className="bg-blue-600 rounded-full p-2 mr-3">
                                <Star className="w-5 h-5 text-black" />
                            </div>
                            <h4 className="text-xl font-bold text-blue-600">Objective</h4>
                        </div>
                    ...
                    {/* Why Play */}
                    <div>
                        <h4 className="text-xl font-bold text-blue-600 text-center mb-6">Why Play Regex Writing?</h4>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { icon: Target, color: "bg-blue-100", title: "Master a Crucial Skill", desc: "Regex is core to validation & parsing." },
                                { icon: Puzzle, color: "bg-blue-100", title: "Problem-Solving Fun", desc: "Regex is like a puzzle for coders." },
                                { icon: Code, color: "bg-blue-100", title: "Practical Application", desc: "Used everywhere from web dev to data science." }
                            ].map((feature, i) => (
                                <div key={i} className="flex items-start space-x-3 p-4 bg-blue-50 rounded-lg">
                                    ...
                                    <div>
                                        <h5 className="font-semibold text-blue-600 mb-1">{feature.title}</h5>
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 mt-8">
                    <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-2xl font-bold text-blue-600">Prizes</h3>
                    </div>
                    <p className="text-blue-600 leading-relaxed">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-50 rounded-2xl shadow-lg p-12 mt-8 text-center">
                    ...
                    <a
                        href="/register"
                        className="inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold px-10 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-lg"
                    >
                ...
                <div className="mt-16 pt-8 border-t-2 border-gray-100">
                    <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl shadow-lg p-8">
                        ...
                        <p className="text-blue-600">
                            Contact us at: <a href="mailto:sponsors@fosster.in" className="text-blue-600 font-semibold">sponsors@fosster.in</a>
                        </p>
                    </div>
                </div>
