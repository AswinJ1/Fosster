        ...
        <section className="relative w-full min-h-screen bg-white text-black py-16 px-6 sm:px-10 lg:px-20 overflow-hidden">
            <div className="relative z-10 max-w-7xl mx-auto space-y-16">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8" style={{
                    backgroundImage: "linear-gradient(135deg, rgba(236, 72, 153, 0.05) 0%, rgba(59, 130, 246, 0.05) 100%)",
                }}>
                ...
                {/* How to Play & Rules */}
                <div className="bg-white rounded-2xl shadow-lg p-8" style={{
                    backgroundImage: "linear-gradient(135deg, rgba(236, 72, 153, 0.04) 0%, rgba(59, 130, 246, 0.04) 100%)",
                }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-10">
                        {[
                            { icon: Keyboard, title: "Access Station", subtitle: "Find a Game Zone station" },
                            { icon: Clock, title: "Start Timer", subtitle: "Your race begins now" },
                            { icon: CheckCircle, title: "Type Precisely", subtitle: "Errors cost time" },
                            { icon: Edit, title: "Complete Snippet", subtitle: "Finish the passage" },
                            { icon: BarChart3, title: "Leaderboard", subtitle: "See your rank instantly" }
                        ].map((step, i) => (
                    ...
                    {/* Why Play */}
                    <div>
                        <h4 className="text-xl font-bold text-blue-600 text-center mb-6">Why Play the Typing Challenge?</h4>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            {[
                                { icon: Zap, title: "Boost Speed", desc: "Improve typing speed, essential for devs." },
                                { icon: CheckCircle, title: "Enhance Accuracy", desc: "Reduce mistakes, save debugging time." },
                                { icon: Edit, title: "Fun & Competitive", desc: "Quick, engaging challenge for bragging rights." }
                            ].map((feature, i) => (
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    <h3 className="text-2xl font-bold text-blue-600 mb-4">Scoring & Winning</h3>
